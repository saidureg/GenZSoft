...
const ServicesCard = ({ data }) => {
  return (
    <div className="relative w-full h-[400px] rounded-lg transition-transform duration-300 hover:scale-105">
      ...
      <div className="absolute sm:w-[285px] lg:w-[315px] h-[210px] lg:h-[196px] top-36 sm:top-40 lg:top-48 left-0 mx-4 lg:ml-[26px] flex flex-col items-center justify-center bg-white rounded-lg shadow-[0px_8px_16px_0px_rgba(171,190,209,0.40)] space-y-4 p-4">
